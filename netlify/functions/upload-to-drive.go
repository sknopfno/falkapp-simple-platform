...
func handler(w http.ResponseWriter, r *http.Request) {
	...
	// Specify the folder ID (replace "your-folder-id" with the actual folder ID)
	folderID := "1Ly2duUWCpo4M2xAKAdVg7OVnZNZPlrdm"

	// Upload file to Google Drive with folder specified
	driveFile := &drive.File{
		Name:    "UploadedFile",     // You can modify this to the actual file name
		Parents: []string{folderID}, // Upload to the specified folder
	}
